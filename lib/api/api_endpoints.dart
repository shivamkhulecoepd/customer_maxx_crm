class ApiEndpoints {
  ...
  static const String getRegistrationRoles = '$_apiPath?action=get_registration_roles';
  
  // Dashboard endpoints
  static const String getAdminStats = '$_apiPath?action=get_admin_stats';
  static const String getLeadManagerStats = '$_apiPath?action=get_lead_manager_stats';
